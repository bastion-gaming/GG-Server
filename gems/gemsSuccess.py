...
objetSuccess = [
    ...
    Success(17, 1, "Reaper", 18, 25, "hothouse|harvest|hops", 100),
    Success(17, 2, "Reaper", 18, 25, "hothouse|harvest|hops", 500),
    Success(17, 3, "Reaper", 18, 25, "hothouse|harvest|hops", 1500),
    Success(17, 4, "Reaper", 18, 25, "hothouse|harvest|hops", 4000),
    Success(17, 5, "Reaper", 18, 25, "hothouse|harvest|hops", 12000),
    Success(17, 6, "Reaper", 18, 25, "hothouse|harvest|hops", 50000),
    Success(17, 7, "Reaper", 18, 25, "hothouse|harvest|hops", 100000),
    Success(17, 8, "Reaper", 18, 25, "hothouse|harvest|hops", 300000),
    Success(17, 9, "Reaper", 18, 25, "hothouse|harvest|hops", 800000),
    Success(17, 10, "Reaper", 18, 25, "hothouse|harvest|hops", 2000000),
    Success(17, 11, "Reaper", 18, 25, "hothouse|harvest|hops", 5000000),
    Success(17, 12, "Reaper", 18, 25, "hothouse|harvest|hops", 15000000),
    Success(17, 13, "Reaper", 18, 25, "hothouse|harvest|hops", 40000000),
    Success(17, 14, "Reaper", 18, 25, "hothouse|harvest|hops", 100000000),
